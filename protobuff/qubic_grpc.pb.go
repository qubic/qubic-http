...
func (c *qubicLiveServiceClient) GetIssuedAssetsByFilter(ctx context.Context, in *GetIssuedAssetsByFilterRequest, opts ...grpc.CallOption) (*AssetIssuances, error) {
	...
	err := c.cc.Invoke(ctx, QubicLiveService_GetIssuedAssetsByFilter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qubicLiveServiceClient) GetIssuedAssetByUniverseIndex(ctx context.Context, in *GetByUniverseIndexRequest, opts ...grpc.CallOption) (*AssetIssuance, error) {
	...
	err := c.cc.Invoke(ctx, QubicLiveService_GetIssuedAssetByUniverseIndex_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qubicLiveServiceClient) GetOwnedAssetsByFilter(ctx context.Context, in *GetOwnedAssetsByFilterRequest, opts ...grpc.CallOption) (*AssetOwnerships, error) {
	...
	err := c.cc.Invoke(ctx, QubicLiveService_GetOwnedAssetsByFilter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qubicLiveServiceClient) GetOwnedAssetByUniverseIndex(ctx context.Context, in *GetByUniverseIndexRequest, opts ...grpc.CallOption) (*AssetOwnership, error) {
	...
	err := c.cc.Invoke(ctx, QubicLiveService_GetOwnedAssetByUniverseIndex_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qubicLiveServiceClient) GetPossessedAssetsByFilter(ctx context.Context, in *GetPossessedAssetsByFilterRequest, opts ...grpc.CallOption) (*AssetPossessions, error) {
	...
	err := c.cc.Invoke(ctx, QubicLiveService_GetPossessedAssetsByFilter_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qubicLiveServiceClient) GetPossessedAssetByUniverseIndex(ctx context.Context, in *GetByUniverseIndexRequest, opts ...grpc.CallOption) (*AssetPossession, error) {
	...
	err := c.cc.Invoke(ctx, QubicLiveService_GetPossessedAssetByUniverseIndex_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qubicLiveServiceClient) GetActiveIpos(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetActiveIposResponse, error) {
	...
	err := c.cc.Invoke(ctx, QubicLiveService_GetActiveIpos_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
