...
const (
	...
	QubicLiveService_GetAssetsForIdentities_FullMethodName           = "/qubic.http.qubic.pb.QubicLiveService/GetAssetsForIdentities"
	...
	QubicLiveService_GetHealth_FullMethodName                        = "/qubic.http.qubic.pb.QubicLiveService/GetHealth"
)
...
type QubicLiveServiceClient interface {
	...
	GetAssetsForIdentities(ctx context.Context, in *GetAssetsForIdentitiesRequest, opts ...grpc.CallOption) (*GetAssetsForIdentitiesResponse, error)
...
func (c *qubicLiveServiceClient) GetAssetsForIdentities(ctx context.Context, in *GetAssetsForIdentitiesRequest, opts ...grpc.CallOption) (*GetAssetsForIdentitiesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAssetsForIdentitiesResponse)
	err := c.cc.Invoke(ctx, QubicLiveService_GetAssetsForIdentities_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *qubicLiveServiceClient) GetHealth(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HealthResponse)
	err := c.cc.Invoke(ctx, QubicLiveService_GetHealth_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QubicLiveServiceServer interface {
	...
	GetAssetsForIdentities(context.Context, *GetAssetsForIdentitiesRequest) (*GetAssetsForIdentitiesResponse, error)
...
func (UnimplementedQubicLiveServiceServer) GetAssetsForIdentities(context.Context, *GetAssetsForIdentitiesRequest) (*GetAssetsForIdentitiesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAssetsForIdentities not implemented")
}
...
func (UnimplementedQubicLiveServiceServer) GetHealth(context.Context, *emptypb.Empty) (*HealthResponse, error) {
...
func _QubicLiveService_GetAssetsForIdentities_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAssetsForIdentitiesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QubicLiveServiceServer).GetAssetsForIdentities(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: QubicLiveService_GetAssetsForIdentities_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QubicLiveServiceServer).GetAssetsForIdentities(ctx, req.(*GetAssetsForIdentitiesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _QubicLiveService_GetHealth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QubicLiveServiceServer).GetHealth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: QubicLiveService_GetHealth_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QubicLiveServiceServer).GetHealth(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var QubicLiveService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAssetsForIdentities",
			Handler:    _QubicLiveService_GetAssetsForIdentities_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _QubicLiveService_GetHealth_Handler,
		},
	},
