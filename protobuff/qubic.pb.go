...
type NextTick struct {
	...
	NextTick uint32 `protobuf:"varint,1,opt,name=next_tick,json=nextTick,proto3" json:"next_tick,omitempty"`
}

func (x *NextTick) Reset() {
	*x = NextTick{}
	if protoimpl.UnsafeEnabled {
...
func (x *NextTick) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NextTick) ProtoMessage() {}

func (x *NextTick) ProtoReflect() protoreflect.Message {
	mi := &file_qubic_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NextTick.ProtoReflect.Descriptor instead.
func (*NextTick) Descriptor() ([]byte, []int) {
	return file_qubic_proto_rawDescGZIP(), []int{8}
}

func (x *NextTick) GetNextTick() uint32 {
	if x != nil {
		return x.NextTick
	}
	return 0
...
var file_qubic_proto_rawDesc = []byte{
	...
	,
	...
	0x22, 0x16, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x10, 0x12, 0x0e, 0x2f, 0x62, 0x61, 0x6c, 0x61, 0x6e,
	0x63, 0x65, 0x73, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x12, 0x9e, 0x01, 0x0a, 0x14, 0x42, 0x72, 0x6f,
	...
	0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x2d, 0x68, 0x65, 0x69, 0x67, 0x68, 0x74, 0x42, 0x28, 0x5a, 0x26,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x71, 0x75, 0x62, 0x69, 0x63,
	0x2f, 0x71, 0x75, 0x62, 0x69, 0x63, 0x2d, 0x68, 0x74, 0x74, 0x70, 0x2f, 0x70, 0x72, 0x6f, 0x74,
...
var file_qubic_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_qubic_proto_goTypes = []interface{}{
	...
	(*NextTick)(nil),                     // 8: qubic.http.qubic.pb.NextTick
...
var file_qubic_proto_depIdxs = []int32{
	...
	9, // 5: qubic.http.qubic.pb.QubicLiveService.GetTickInfo:input_type -> google.protobuf.Empty
	9, // 6: qubic.http.qubic.pb.QubicLiveService.GetBlockHeight:input_type -> google.protobuf.Empty
