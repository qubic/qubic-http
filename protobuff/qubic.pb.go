...
const file_qubic_proto_rawDesc = "" +
	"\n" +
	"\vqubic.proto\x12\x13qubic.http.qubic.pb\x1a\x1cgoogle/api/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1bopenapiv3/annotations.proto\"\xd2\x03\n" +
	"\aBalance\x12-\n" +
	"\x02id\x18\x01 \x01(\tB\x1d\xbaG\x1a\x92\x02\x17This is the descriptionR\x02id\x12\x18\n" +
