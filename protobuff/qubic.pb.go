...
var file_qubic_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0x8b, 0x03, 0x0a, 0x0c, 0x51, 0x75, 0x62, 0x69,
	0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x75, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x42,
	...
	0x2d, 0x69, 0x6e, 0x66, 0x6f, 0x42, 0x28, 0x5a, 0x26, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_qubic_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
var file_qubic_proto_depIdxs = []int32{
	...
	1, // 2: qubic.http.qubic.pb.QubicService.GetBalance:input_type -> qubic.http.qubic.pb.GetBalanceRequest
	3, // 3: qubic.http.qubic.pb.QubicService.BroadcastTransaction:input_type -> qubic.http.qubic.pb.BroadcastTransactionRequest
	7, // 4: qubic.http.qubic.pb.QubicService.GetTickInfo:input_type -> google.protobuf.Empty
	2, // 5: qubic.http.qubic.pb.QubicService.GetBalance:output_type -> qubic.http.qubic.pb.GetBalanceResponse
	4, // 6: qubic.http.qubic.pb.QubicService.BroadcastTransaction:output_type -> qubic.http.qubic.pb.BroadcastTransactionResponse
	6, // 7: qubic.http.qubic.pb.QubicService.GetTickInfo:output_type -> qubic.http.qubic.pb.GetTickInfoResponse
